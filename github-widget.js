...
(function() {
  ...
  makeWidget = function(payload, div) {
    var i, len, limit, ref, repo, results, siteRepoName, sortBy, user;
    make({
      cls: 'gw-clearer',
      prevSib: div
    });
    ...
    limit = parseInt(div.getAttribute('data-limit') || Infinity);
    sortBy = div.getAttribute('data-sortby') || 'watchers';
